...
def serie_single_processor(serie):
    for id_data in filter((lambda dat: dat['designator'] == 'Id' ),serie['data']):
            ...
            filename = outputdir/PureWindowsPath("id_bins_normalized\\" + serie['title'] + ".png")
...
filename = Path(scriptdir/PureWindowsPath('data\\id_bins_normalized.json'))
outputdir = sys.argv[2]
outputdir = PureWindowsPath(outputdir + '\\id_bins_normalized')
